...
const leaders = [
  ...
  // },
  {
    ...
    image: "/images/sanjana-sharan.jpeg",
  ...
  return (
    <section id="leadership" className="py-20 lg:py-28 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex justify-center gap-8 lg:gap-12 max-w-5xl mx-auto">
            ...
            >
              <div className="relative mb-6 overflow-hidden">
                <img
                  src={leader.image}
                  alt={leader.name}
                  className="w-full h-[400px] object-contain object-center transition-transform duration-500"
